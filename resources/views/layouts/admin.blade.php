            ...
            <header class="bg-white shadow-sm flex-shrink-0">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center py-4">
                    ...
                    <div class="flex items-center gap-4">
                        <a href="{{ route('admin.profile.edit') }}" title="Edit Profil" aria-label="Edit Profil"
                            class="inline-flex items-center justify-center p-2 text-emerald-600 bg-emerald-100 rounded-lg shadow hover:bg-emerald-200">
