...
<head>
    ...
    <title>@yield('title', 'Dashboard Dosen') - Teknik Radiologi Pencitraan</title>
    ...
    <div class="h-screen flex">
        <aside class="hidden lg:flex flex-col w-72 bg-emerald-700 text-white fixed left-0 top-0 h-screen">
            <div class="p-6 flex items-center gap-3 border-b border-emerald-500/50 flex-shrink-0">
                ...
                <div>
                    <p class="text-xs uppercase tracking-widest text-emerald-200">Panel Dosen</p>
            ...
            <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
                <x-guru-nav-item route="guru.dashboard" icon='<i class="fa-solid fa-gauge-high"></i>'>Dashboard</x-guru-nav-item>
                <x-guru-nav-item route="guru.subjects.index" icon='<i class="fa-solid fa-book"></i>'>Mata Kuliah</x-guru-nav-item>
                <x-guru-nav-item route="guru.attendances.index" icon='<i class="fa-solid fa-calendar-check"></i>'>Absensi</x-guru-nav-item>
                <x-guru-nav-item route="guru.tasks.index" icon='<i class="fa-solid fa-list-check"></i>'>Tugas</x-guru-nav-item>
            <x-guru-nav-item route="guru.exams.index" icon='<i class="fa-solid fa-file-pen"></i>'>Ujian Matakuliah</x-guru-nav-item>
                <x-guru-nav-item route="guru.grades.index" icon='<i class="fa-solid fa-chart-line"></i>'>Nilai Mahasiswa</x-guru-nav-item>
            </nav>
            <div class="p-4 border-t border-emerald-500/50 text-sm text-emerald-100 flex-shrink-0 flex items-center gap-3">
                <img src="{{ auth()->user()->profile_photo_url }}" alt="Foto Dosen" class="h-9 w-9 rounded-full bg-white object-cover">
                <div>
            ...
            <header class="bg-white shadow-sm flex-shrink-0">
                <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center py-4">
                    <div class="flex items-center gap-3">
                        ...
                        <h1 class="text-xl font-semibold text-emerald-900">@yield('header', 'Ringkasan Dosen')</h1>
                    </div>
    ...
    <div id="mobileSidebar" class="lg:hidden fixed inset-0 bg-black/50 z-40 hidden">
        <div class="bg-emerald-700 text-white w-72 h-full p-6 space-y-4">
            <div class="flex justify-between items-center">
                <span class="text-lg font-semibold">Menu Dosen</span>
