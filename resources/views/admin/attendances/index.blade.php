...
@section('header', 'Data Absensi Seluruh Kelas')

@section('content')
    <div class="flex flex-col gap-6">
        <div class="flex flex-wrap items-center justify-between gap-4">
            <div>
                <h2 class="text-lg font-semibold text-emerald-900">Rekap Absensi</h2>
<p class="text-sm text-emerald-500">Pantau kehadiran mahasiswa per mata kuliah.</p>
            </div>
                    ...
                    <tbody class="divide-y divide-emerald-50">
                        @forelse ($attendances as $attendance)
                            <tr class="hover:bg-emerald-50/40">
                                ...
                                <td class="px-4 py-3 font-medium text-emerald-900">{{ $attendance->student?->name ?? '—' }}</td>
