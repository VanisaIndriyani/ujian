...
<div class="bg-white border border-emerald-100 rounded-2xl shadow overflow-hidden">
    <div class="px-4 py-3 border-b border-emerald-100">
        <form method="GET" action="{{ route('guru.grades.tasks') }}" class="flex flex-wrap items-center gap-3 text-sm">
    ...
    <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-emerald-100 text-sm">
            ...
            <tbody class="divide-y divide-emerald-50">
                ...
                @empty
                    <tr>
                        <td colspan="5" class="px-4 py-6 text-center text-emerald-400">Belum ada submissions tugas.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
