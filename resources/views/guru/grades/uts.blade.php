...
@section('title', 'Nilai UTS')
@section('header', 'Nilai UTS')
...
<div class="bg-white border border-emerald-100 rounded-2xl shadow overflow-hidden">
    <div class="px-4 py-3 border-b border-emerald-100">
        <form method="GET" action="{{ route('guru.grades.uts') }}" class="flex flex-wrap items-center gap-3 text-sm">
        ...
        <table class="min-w-full divide-y divide-emerald-100 text-sm">
            <thead class="bg-emerald-50/60 text-emerald-600 uppercase text-xs tracking-wider">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left">Judul UTS</th>
            ...
            <tbody class="divide-y divide-emerald-50">
                ...
                @empty
                    <tr>
                        <td colspan="5" class="px-4 py-6 text-center text-emerald-400">Belum ada data UTS yang dikerjakan.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
